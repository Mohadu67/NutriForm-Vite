...
const { login, register, me, updateProfile, changePassword, logout, resendVerificationEmail, getWsToken, getNotificationPreferences, updateNotificationPreferences, deleteAccount, googleAuth, setPassword } = require('../controllers/auth.controller.js');
...
// Définir un mot de passe (OAuth users)
